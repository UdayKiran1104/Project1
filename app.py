...
with open('C:\\Users\\kasan\\OneDrive\\Desktop\\Product sentiment analyser\\ProductSentimentAnalyzer\\logistic_regression_model.pkl', 'rb') as model_file:
    loaded_model = pickle.load(model_file)

with open('C:\\Users\\kasan\\OneDrive\\Desktop\\Product sentiment analyser\\ProductSentimentAnalyzer\\tfidf_vectorizer.pkl', 'rb') as vectorizer_file:
    loaded_vectorizer = pickle.load(vectorizer_file)

# Set up Selenium WebDriver (Ensure to set the path to your chromedriver)
chrome_driver_path = "C:\\Users\\kasan\\Downloads\\chromedriver-win64 (1)\\chromedriver-win64\\chromedriver.exe"
